    ...
    switch (type) {
      case CampusButtonType.primary:
        return _ButtonStyle(
          ...
          disabledBackgroundColor: CampusColors.primary.withValues(alpha: 0.5),
      ...
      case CampusButtonType.secondary:
        return _ButtonStyle(
          ...
          foregroundColor: Colors.white,
          disabledBackgroundColor: CampusColors.secondary.withValues(alpha: 0.5),
          disabledForegroundColor: Colors.white.withValues(alpha: 0.7),
        );
      case CampusButtonType.outline:
        return _ButtonStyle(
          ...
          disabledForegroundColor: CampusColors.primary.withValues(alpha: 0.5),
        );
      case CampusButtonType.text:
        return _ButtonStyle(
          backgroundColor: Colors.transparent,
