          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      if (selectedFile != null)
                        ListTile(
                          ...
                          title: Text(selectedFile!.name, maxLines: 1, overflow: TextOverflow.ellipsis),
                          trailing: IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (result != null) {
                              setDialogState(() {
                                ...
                                if (title.isEmpty) {
                                  title = selectedFile!.name.split('.').first;
                                }
                                if (selectedFile!.extension?.toLowerCase() == 'pdf') type = 'PDF';
                              });
                            }
                          },
                ...
                const SizedBox(height: 16),
                TextField(
                  decoration: const InputDecoration(labelText: 'Ou URL externe'),
                  onChanged: (v) => url = v,
                ),
                const SizedBox(height: 16),
                TextField(
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  if (selectedFile != null) {
                    ...
                    finalUrl = await ResourceService.uploadResourceFile(selectedFile!.name, bytes);
                  }

                  if (finalUrl.isEmpty) {
                    Navigator.pop(context); // Close loading
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Veuillez sélectionner un fichier ou entrer une URL')));
                    return;
                  }
