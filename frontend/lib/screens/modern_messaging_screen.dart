...
import '../messaging/controllers/messaging_providers.dart';
...
class _ModernMessagingScreenState extends ConsumerState<ModernMessagingScreen> {
  ...
  Widget _buildConversationCard(ChatConversation conversation, bool isSelected) {
    return GestureDetector(
      onTap: () {
        ref.read(selectedConversationProvider.notifier).state = conversation;
        ref.read(messagingControllerProvider.notifier).markAsRead(conversation.id);
      },
      onLongPress: () {
        showDialog(
          context: context,
            ...
            actions: [
              ...
              TextButton(
                onPressed: () async {
                  ...
                  try {
                    await MessagingService.clearChat(conversation.id);
  ...
  Widget _buildConversationArea(ChatConversation conversation) {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: FutureBuilder<List<Map<String, dynamic>>>(
                        future: MessagingService.getAvailableContacts(),
                        builder: (context, snapshot) {
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                onTap: () async {
                                  Navigator.pop(context);
                                  try {
                                    final convId = await MessagingService.getOrCreateConversation(contact['id']);
